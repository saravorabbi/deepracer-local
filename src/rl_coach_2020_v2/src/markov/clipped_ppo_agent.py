...
class ClippedPPOAgentParameters(AgentParameters):
    def __init__(self):
        print("ClippedPPOAgentParameters - CHIAMO ALGORITMO PPO")
...
#@property, ritorna l'indirizzo di memoria di 'markov.clipped_ppo_agent:ClippedPPOAgent'

    @property
    def path(self):
        #return 'rl_coach.agents.clipped_ppo_agent:ClippedPPOAgent'
        return 'markov.clipped_ppo_agent:ClippedPPOAgent'
...
class ClippedPPOAgent(ActorCriticAgent):
    def __init__(self, agent_parameters, parent: Union['LevelManager', 'CompositeAgent']=None):
        print("ClippedPPOAgent - CHIAMO ALGORITMO PPO")
    ...
    def train(self):
        print("ClippedPPOAgent CHIAMO FUNZIONE TRAIN - ALGORITMO PPO")
